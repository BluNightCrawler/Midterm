...
public class UpdateCourseActivity extends AppCompatActivity {
    ...
    private Button updateCourseBtn, deleteCourseBtn, createPersonBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createPersonBtn = findViewById(R.id.idBtnCreate);
        ...
        createPersonBtn.setOnClickListener(new View.OnClickListener(){
